...
export default function ScanCoupeScreen({ navigation }) {
    ...
    const sendScannedData = async () => {
        if (scannedDataList.length > 0) {
            ...
            const apiUrl = `${config.API_HOST}/qrCoupe`;
                    ...
                    <View style={styles.tableContainer}>
                        ...
                        <View style={styles.table}>
                            <View style={styles.tableRow}>
                                <Text style={styles.tableCell}>Modèle</Text>
                                <Text style={styles.tableCell}>OF</Text>
                                <Text style={styles.tableCell}>Taille</Text>
                                <Text style={styles.tableCell}>Identités</Text>
                            </View>
                            {groupedDataArray.map((group, index) => (
                                <View key={index} style={styles.tableRow}>
                                    ...
                                    <Text style={styles.tableCell}>{group.identites.length > 0 ? group.identites.join(', ') : ''}</Text>
                                </View>
                            ))}
