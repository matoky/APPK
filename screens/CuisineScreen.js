...
import ScannerScreen from './Cuisine/ScannerScreen';
      ...
      <View style={styles.bottomBar}>
        ...
        >
          ...
          <Text style={[styles.barText, activeSheet === 'Personnels' && styles.activeText]}>Personnels</Text>
            ...
            >
            <FontAwesome5 name="utensils" size={24} color={activeSheet === 'CUISINE' ? '#80FF00' : '#fff'} />
            <Text style={[styles.barText, activeSheet === 'CUISINE' && styles.activeText]}>Cuisine</Text>
            </TouchableOpacity>
