...
import { decode as base64Decode } from 'base-64';
 import CaptureScreen from './Superviseur/CaptureScreen';
 import ChatScreen from './Superviseur/ChatScreen';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomBar}>
        ...
        >
          <Icon name="camera" size={24} color={activeSheet === 'Scanner' ? '#80FF00' : '#fff'} />
