...
const ChatScreen = () => {
  ...
  const [unreadCount, setUnreadCount] = useState(0); // ✅ état pour messages non lus
  ...
  // ✅ Réinitialise les messages non lus quand l’écran est actif
  useFocusEffect(
    useCallback(() => {
      setUnreadCount(0);
    }, [])
  ...
  useEffect(() => {
    ...
    socket.on('newMessage', (msg) => {
      ...
      // ✅ Ajouter +1 au nombre de messages non lus
